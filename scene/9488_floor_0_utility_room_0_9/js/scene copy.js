...
function add_threejs_objects_to_scene(threejs_objects){
				...
				if (typeof event.target !== 'undefined'){
					if (event.target.isObject3D && event.target.name !== 'static_scene' && event.target.children[0] !== 'undefined') {
						event.target.children[0].traverse(
							function(child) {
								if (child.isMesh) {
									child.material.color.set(0x58d68d);
								}
							});
			...
			value.addEventListener('mouseup', (event) => {
				...
				if (event.intersected) {
					if (typeof event.target !== 'undefined'){
						...
						// 	var tween = new TWEEN.Tween(event.target.children[0].rotation)
						// 	.to({ x: Math.PI/2}, 1000)
						// 	.delay(1000)
						// 	.onComplete(function() {
						// 		if (Math.abs(event.target.children[0].rotation.x)>=2*Math.PI) {
						// 			event.target.children[0].rotation.yx = event.target.children[0].rotation.x % (2*Math.PI);
						// 		}
						// 	})
						// 	.start();
						...
						// 	.onComplete(function() {
						// 		if (Math.abs(event.target.children[0].rotation.x)>=2*Math.PI) {
						// 			event.target.children[0].rotation.x = event.target.children[0].rotation.x % (2*Math.PI);
						// 		}
						// 	})
						// 	.start();
						...
						// var end = {angle: cubeAngle + Math.PI / 2};
						...
						// 		//rotate only delta
						// 		event.target.children[0].rotateAroundWorldAxis(new THREE.Vector3(0,0,0), new THREE.Vector3(0,1,0), cubeAngle-lastAngle);
						...
						if (threejs_objects_state[event.target.name] == false){
							...
							if (joint_type == 0){
								var bbox = new THREE.Box3().setFromObject(event.target);
								console.log(bbox)
								event.target.rotateAroundWorldAxis(new THREE.Vector3(screw_point[0], screw_point[1], screw_point[2]), new THREE.Vector3(screw_axis[0], screw_axis[1], screw_axis[2]), Math.PI / 2);
						...
						// (-0.19508715, -0.38369934, -0.47058197) + (0.18526279, 0.05674555, 0.04247309)
						// (0.11042866, 0.0036797, 0.09613317)
						// event.target.rotateAroundWorldAxis(new THREE.Vector3(-0.01, -0.33, -0.43), new THREE.Vector3(0., 1, 0.), Math.PI / 2);
						// console.log(event.target.children[0].position)
						// var tt = new THREE.Vector3(0.11042866, 0.0036797, 0.09613317)
						// event.target.rotateAroundWorldAxis(new THREE.Vector3(0.07, 0.053, -0.054), new THREE.Vector3(0., 1, 0.), Math.PI / 2);
						// event.target.rotateAroundWorldAxis(new THREE.Vector3(-0.37, -0.43, -0.51), new THREE.Vector3(0., 1, 0.), Math.PI / 2);
	...
	const points = [];
	// points.push( new THREE.Vector3( 0.1964929,  0.11291125,  0.11469191 ) );
	// points.push( new THREE.Vector3( 0.1964929,  100.11291125,  0.11469191 ) );
	// points.push( new THREE.Vector3( -0.1666261,  0.06806427, -0.21628125 ) );
	// points.push( new THREE.Vector3( -0.1666261,  100.06806427, -0.21628125 ) );
	points.push( new THREE.Vector3( -0.15385379, 0.03674648,  0.11861751 ) );
	points.push( new THREE.Vector3( -0.15385379, 0.03674648,  100.11861751 ) );
